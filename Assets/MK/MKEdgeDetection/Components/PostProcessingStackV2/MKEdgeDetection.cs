...
/* Version: 1.2.8  */
/* Exported on: 21.03.2026 14:58:29 */
	...
	public sealed class MKEdgeDetection : UnityEngine.Rendering.PostProcessing.PostProcessEffectSettings, MK.EdgeDetection.PostProcessingStackV2VolumeComponents.IParameters
	{
		...
		public sealed class MKEdgeDetectionRenderer : UnityEngine.Rendering.PostProcessing.PostProcessEffectRenderer<MKEdgeDetection>, MK.EdgeDetection.PostProcessing.Generic.ICameraData
		{
			...
			*/
			...
			public int widthRaw => _renderingContext.camera.allowDynamicResolution ? Mathf.RoundToInt(_renderingContext.camera.pixelWidth * ScalableBufferManager.widthScaleFactor) : _renderingContext.camera.pixelWidth;
			public int heightRaw => _renderingContext.camera.allowDynamicResolution ? Mathf.RoundToInt(_renderingContext.camera.pixelHeight * ScalableBufferManager.heightScaleFactor) : _renderingContext.camera.pixelHeight;
