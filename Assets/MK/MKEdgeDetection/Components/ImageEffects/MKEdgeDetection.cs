...
/* Version: 1.2.8  */
/* Exported on: 21.03.2026 14:58:30 */
...
namespace MK.EdgeDetection.ImageEffectsComponents
{
	...
	public sealed class MKEdgeDetection : UnityEngine.MonoBehaviour, MK.EdgeDetection.ImageEffectsComponents.IParameters, MK.EdgeDetection.PostProcessing.Generic.ICameraData
	{
		...
		*/
		...
		#if ENABLE_VR && MK_VR_ENABLED || UNITY_6000_5_OR_NEWER
		...
		public int widthRaw => _renderingCamera.allowDynamicResolution ? Mathf.RoundToInt(_renderingCamera.pixelWidth * ScalableBufferManager.widthScaleFactor) : _renderingCamera.pixelWidth;
		public int heightRaw => _renderingCamera.allowDynamicResolution ? Mathf.RoundToInt(_renderingCamera.pixelHeight * ScalableBufferManager.heightScaleFactor) : _renderingCamera.pixelHeight;
