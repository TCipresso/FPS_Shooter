Shader "Bloodsport/WorldAligned_Dynamic"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                // Use UNITY_MATRIX_M directly - safe here since these objects are
                // NOT static batched, so the matrix reflects the real per-object
                // transform every frame. Do not use this shader on static batched
                // renderers; use WorldAligned_Fixed instead.
